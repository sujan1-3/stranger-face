# Combine CSS parts into one complete file
with open('frontend-style-part1.css', 'r', encoding='utf-8') as f1:
    css_part1 = f1.read()

with open('frontend-style-part2.css', 'r', encoding='utf-8') as f2:
    css_part2 = f2.read()

complete_css = css_part1 + css_part2

# Save complete CSS file
save_file('frontend-style.css', complete_css)

# Now create the JavaScript file - this is also quite large
frontend_app_js = '''/**
...
save_file('frontend-app.js', frontend_app_js)